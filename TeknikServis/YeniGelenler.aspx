<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="YeniGelenler.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <div class="panel-heading">
    <h3 class="panel-title" style="font-weight: bold">Yeni Gelenler</h3>
  </div>
...
<div style="overflow:auto; margin-top:30px;">
    ...
    <asp:GridView ID="tablo_grid"  class="table" runat="server" 
        ...
        onrowediting="tablo_grid_RowEditing" onrowdatabound="tablo_grid_RowDataBound" 
        >
        <Columns>
        ...
        <emptydatatemplate>
            ...
            <p style="font-size:large;color: #2c3e50; background-image: url('Styles/bos2.png'); background-repeat: no-repeat; margin-left:280px; text-align:center; width: 400px; height: 250px; padding-top: 80px; padding-right:140px;"> Yeni Gelen Arıza Yok.</p> 
